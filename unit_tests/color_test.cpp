...
TEST_CASE("colors")
{
  ...
  {
    const lib::color::color color_1 = lib::color::init(0xFFFFFFFF);
    ...
    const lib::color::color color_2 = lib::color::init(0xFFCC3300);
  ...
  SECTION("Init integer with components")
  {
    ...
    const lib::color::color color_1 = lib::color::init(color_data.at(0), color_data.at(1), color_data.at(2), color_data.at(3));
    ...
    const lib::color::color color_2 = lib::color::init(color_data.data());
